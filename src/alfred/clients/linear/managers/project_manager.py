...
class ProjectManager(BaseManager[LinearProject]):
    ...
    @enrich_with_client
    def create(
        self, name: str, team_name: str, description: Optional[str] = None
    ) -> LinearProject:
        """
        ...
        self._cache_clear()
        self.client.teams._cache_invalidate(
            "all_teams", "all"
        )  # Also invalidate team cache
    ...
    def update(self, project_id: str, **kwargs) -> LinearProject:
        ...
        response = self._execute_query(
            update_project_mutation, {"id": project_id, "input": kwargs}
        )
    ...
    def get_all(self, team_id: Optional[str] = None) -> Dict[str, LinearProject]:
        ...
        if team_id:
            ...
            # Get projects using our improved helper method
            project_nodes = self._handle_pagination(query, {}, ["projects", "nodes"])
        ...
        for project_data in project_nodes:
            try:
                ...
                self._cache_set(
                    "project_ids_by_name", (project.name, team_id), project.id
                )
    ...
    def get_id_by_name(self, project_name: str, team_id: Optional[str] = None) -> str:
        ...
        if team_id:
            ...
            # Get the projects using our improved helper method
            projects = self._handle_pagination(query, {}, ["projects", "nodes"])
    ...
    def get_issues(self, project_id: str) -> List[LinearIssue]:
        ...
        issues = self._extract_and_cache(
            response, ["project", "issues"], "issues_by_project", project_id
        )
    ...
    def get_initiatives(self, project_id: str) -> List[Dict[str, Any]]:
        ...
        initiatives = self._extract_and_cache(
            response, ["project", "initiatives"], "initiatives_by_project", project_id
        )
