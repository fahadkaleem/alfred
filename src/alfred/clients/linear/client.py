"""
Alfred Linear API Client

Internal Linear GraphQL API client for Alfred Task Manager.
This module provides the main entry point for Alfred's Linear API client.
"""
...
class LinearClient:
    ...
    and serves as the entry point for Alfred's Linear integration.
    ...
    def validate_schema(
        self, model_class: type[LinearModel]
