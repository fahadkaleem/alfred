...
from alfred.clients.linear import LinearClient, LinearTeam
from alfred.clients.linear.domain import LinearProject, ProjectMilestone, Comment
...
def test_create_project(client, test_team_name):
    ...
    try:
        ...
        assert (
            project.description == "This is a test project for testing project creation"
        )
    finally:
...
def test_update_project(client, test_project):
    ...
    updated_project = client.projects.update(
        test_project.id, name=new_name, description=new_description
    )
