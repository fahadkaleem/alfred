...
@pytest.mark.asyncio
async def test_enhance_task_scope_logic(mock_linear_adapter, sample_task, sample_alfred_task):
...
@pytest.mark.asyncio
async def test_simplify_task_logic(mock_linear_adapter, sample_task, sample_alfred_task):
...
@pytest.mark.asyncio
async def test_enhance_with_no_changes(mock_linear_adapter, sample_task, sample_alfred_task):
